...
class HufsfoodRestaurant(models.Model):
    ...
    brstr = models.TimeField(blank=True, null=True)
    brend = models.TimeField(blank=True, null=True)
    tel = models.CharField(max_length=20, blank=True, null=True)
    alone = models.CharField(max_length=10, blank=True, null=True)
